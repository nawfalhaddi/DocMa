...
const MedecinPatientProfilHeader = (props) => {
    const [selectedItem, setSelectedItem] = useState(1)

    return (
        <View style={styles.screen}>
            <View style={styles.headercontainer}>
                <Icon containerStyle={{ marginTop: 35, marginLeft: 10 }} color="white" type="material" name="close" onPress={() => {
                    props.exitModal();
                }} />
            ...
            <View style={styles.circlesContainer}>
                <View style={styles.circleAndTextContainer}>
                    <TouchableOpacity activeOpacity={0.8} style={styles.circleContainer} onPress={() => {
                        setSelectedItem(1);
                        // RootNavigation.navigate('consultations')
                        props.firstItemFunc();
                    }}>
                ...
                <View style={styles.circleAndTextContainer}>
                    <TouchableOpacity activeOpacity={0.8} style={styles.circleContainer} onPress={() => {
                        setSelectedItem(2);
                        // RootNavigation.navigate('patients')
...
export default MedecinPatientProfilHeader
